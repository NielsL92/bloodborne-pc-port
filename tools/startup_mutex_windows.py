...
p=argparse.ArgumentParser();p.add_argument('out',type=Path);p.add_argument('--full-helper',action='store_true');a=p.parse_args();a.out.mkdir(parents=True,exist_ok=False)
