...
def main():
    ...
    def compile_batch(batch,tag):
        ...
        result['lift']=run([lifter,folder/'input.json',folder/'function.bc',folder/'function.ll',folder/'audit.json'],folder,'lift');result['status']='lift_rejected'
