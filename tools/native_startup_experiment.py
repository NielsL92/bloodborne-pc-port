...
native=[]
for name in ['fault','memory','control','intrinsics','fp','sourced','loader','canary','mutexattr','mutex','direct_memory','startup_fixture','registry']:
